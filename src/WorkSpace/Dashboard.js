      ...
      <Aux>
        <Row>
                ...
                <div className="row align-items-center justify-content-center">
                  ...
                  <div className="col text-right">
                    ...
                    <h5 className="text-c-green mb-0">
                      +7.2% <span className="text-muted">3 Months fee due</span>
                    </h5>
                  </div>
                </div>
              </Card.Body>
          ...
          <Col md={6} xl={4}>
            <Card>
              <Card.Header>
                <Card.Title as="h5">New Admission</Card.Title>
              </Card.Header>
          ...
          <Col md={6} xl={8} className="m-b-30">
            <Tabs defaultActiveKey="All" id="uncontrolled-tab-example">
              <Tab eventKey="3 Months" title="3 Months">
                {tabContent}
              </Tab>
              <Tab eventKey="2 Months" title="2 Months">
                {tabContent}
              </Tab>
              <Tab eventKey="1 Months" title="1 Months">
                {tabContent}
              </Tab>
